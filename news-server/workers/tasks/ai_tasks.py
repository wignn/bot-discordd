    ...
    async def _process():
        try:
            ...
            try:
                ...
                await broadcast_new_article(broadcast_data)
                
                if result.impact_level == "high" or (result.impact_score and result.impact_score >= 7):
                    await broadcast_high_impact_alert(broadcast_data)
